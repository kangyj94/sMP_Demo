...
jq(function() {
	jq("#list").jqGrid({
		...
		datatype: 'json',
		mtype: 'POST',
		colNames:['발주일','납품요청일','배송정보입력일','인수일','고객유형','주문번호','상품명','규격','대표규격','발주차수','출하차수','인수차수','정산번호','공사명','주문유형','주문상태','고객사','공급사','주문자','인수자','인수자 전화번호','발주수량','단가','금액','취소사유','세금계산서일자','vendorId','branchId','sum_total_sale_unit_pric', 'sum_orde_requ_quan'],
		colModel:[
...
function exportExcel() {
	var colLabels = ['발주일','납품요청일','배송정보입력일','인수일','고객유형','주문번호','상품명','규격','발주차수','출하차수','인수차수','정산번호','공사명','주문유형','주문상태','고객사','공급사','주문자','인수자','인수자 전화번호','발주수량','단가','금액','취소사유','세금계산서일자'];
