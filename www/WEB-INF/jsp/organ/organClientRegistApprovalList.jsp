...
jq(function() {
	jq("#list").jqGrid({
		...
		datatype: 'json',
		mtype: 'POST',
		colNames:['요청법인명', '사업자등록번호', '권역', '상태', '대표전화번호', '대표자명', '우편번호', '주소', '요청일', '승인일(등록일)'],
		colModel:[
			{name:'요청법인명',index:'요청법인명', width:90,align:"center",search:false,sortable:true, editable:false },
...
//개발시 삭제
function onDetail(){
	var popurl = "/organ/organClientRegistApprovalDetail.sys";
	var popproperty = "dialogWidth:900px;dialogHeight=900px;scroll=yes;status=no;resizable=no;";
				...
				<td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr valign="top">
							...
							<td height="29" class='ptitle'>고객법인 등록요청 조회</td>
			...
			<tr>
				<td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td class="table_td_subject" width="100">요청 법인명</td>
							<td class="table_td_contents"><input id="srcLoginId" name="srcLoginId" type="text" value="" size="" maxlength="50" style="width: 200px" /></td>
							<td width="100" class="table_td_subject">상태</td>
							<td class="table_td_contents"><select id="srcIsDefault5" name="srcIsDefault5" class="select"> <option value="">선택하세요</option> </select></td>
						</tr>
						<tr>
							<td colspan="4" class="table_top_line"></td>
						</tr>
