...
function fnIsValidation(){
    ...
    var ebillEmail = $.trim($("#ebillEmail").val());
               ...
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                     ...
                     <td colspan="3" class="table_td_contents">
                        <input id="clientNm" name="clientNm" type="text" value="<%=detailDto.getClientNm().substring(0, detailDto.getClientNm().lastIndexOf("&gt;")) %>" maxlength="50" readonly="readonly" disabled="disabled" style="width:400px"/>
                     </td>
                     <td class="table_td_subject9" style="width:100px">업종</td>
                     <td class="table_td_contents">
                        <input id="branchBusiType" name="branchBusiType" type="text" value="<%=detailDto.getBranchBusiType() %>" maxlength="30"  style="width:125px"/>
                     </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td class="table_td_contents">
						<input id="businessNum1" name="businessNum1" type="text" value="<%=detailDto.getBusinessNum().substring(0, 3) %>" maxlength="3" readonly="readonly" disabled="disabled" style="width:30px"/> - 
						<input id="businessNum2" name="businessNum2" type="text" value="<%=detailDto.getBusinessNum().substring(3, 5) %>" maxlength="2" readonly="readonly" disabled="disabled" style="width:20px"/> - 
						<input id="businessNum3" name="businessNum3" type="text" value="<%=detailDto.getBusinessNum().substring(5) %>" maxlength="5" readonly="readonly" disabled="disabled" style="width:50px"/>
                     </td>
...
%>                     
                        <input id="registNum1" name="registNum1" type="text" value="<%=registNum1 %>" maxlength="6" onkeydown="return onlyNumber(event)" style="width:60px"/> - 
                        <input id="registNum2" name="registNum2" type="text" value="<%=registNum2 %>" maxlength="7" onkeydown="return onlyNumber(event)" style="width:60px"/>
                  ...
                  <tr>
                     <td class="table_td_subject9">주소</td>
                     <td colspan="5" class="table_td_contents">
                        ...
                        <input id="addres" name="addres" type="text" value="<%=detailDto.getAddres() %>" size="20" maxlength="30" style="width: 30%"/>
                        <input id="addresDesc" name="addresDesc" type="text" value="<%=detailDto.getAddresDesc() %>" size="20" maxlength="30" style="width: 40%" />
                     </td>
                  </tr>
                  <tr>
                     <td colspan="6" height='1' bgcolor="eaeaea"></td>
                  ...
                  <tr>
                     <td class="table_td_subject9">대표 이메일</td>
                     <td colspan="5" class="table_td_contents">
                        <input id="eMail" name="eMail" type="text" value="<%=detailDto.getE_mail() %>" size="63" maxlength="30" style="ime-mode: disabled;"/> ex)admin@unpamsbank.com</td>
                     </td>
            	  </tr>
                  <tr>
                     <td colspan="6" height='1' bgcolor="eaeaea"></td>
                  ...
                  <tr>
                     <td class="table_td_subject9">회계담당자(연락처)</td>
                     <td colspan="3" class="table_td_contents">
                        <input id="accountManageNm" name="accountManageNm" type="text" value="<%=detailDto.getAccountManageNm() %>" size="20" maxlength="30" style="width: 20%" />
                     ...
                     <td class="table_td_contents">
                        <input id="homePage" name="homePage" type="text" value="<%=detailDto.getHomePage() %>" size="20" maxlength="30" style="ime-mode: disabled;"/>
                     </td>
                  </tr>
                  <tr>
                     <td colspan="6" height='1' bgcolor="eaeaea"></td>
                  ...
                  <tr>
                     <td class="table_td_subject9">대금정산정보</td>
                     <td colspan="5" class="table_td_contents">
...
%>                      
						...
						계좌번호 :  <input id="accountNum" name="accountNum" type="text" value="<%=detailDto.getAccountNum() %>" size="15" maxlength="20" onkeydown="return onlyNumber(event)"/> (-없이) , 
						예금주 : <input id="recipient" name="recipient" type="text" value="<%=CommonUtils.getString(detailDto.getRecipient())  %>" size="20" maxlength="30" style="width: 20%" />
                     </td>
            	  </tr>
                  <tr>
                     <td colspan="6" height='1' bgcolor="eaeaea"></td>
            	  ...
            	  <tr>
                     ...
                     <td class="table_td_contents">
                     	<input id="loanLimit" name="loanLimit" type="text" size="20" maxlength="30" style="width: 98%" value="<%= CommonUtils.getIntString(detailDto.getClt_loan()) %>" readonly="readonly" disabled="disabled"/>
                     </td>
            	  ...
            	  <tr>
                     <td class="table_td_subject9">운영상태</td>
                     <td class="table_td_contents">
                     ...
                     <td class="table_td_subject9">채권담당자</td>
                     <td class="table_td_contents">
...
%>                              
                  ...
                  <tr>
                     <td class="table_td_subject9" width="100">사업자등록첨부<br/>
                        <a href="#">
                     ...
                     <td class="table_td_subject" width="100">신용평가서첨부<br/>
                        <a href="#">
                     ...
                     <td class="table_td_subject" width="100">통장사본첨부<br/>
                        <a href="#">
                  ...
                  <tr>
                     ...
                     <td class="table_td_subject" width="100">회사계약서<br/>
                        <a href="#">
            ...
            <td>
               ...
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="table_td_subject9">공사등급</td>
                    <td class="table_td_contents">
...
%>                              
                ...
                <tr>
                    <td class="table_td_subject9">계약구분</td>
                    <td class="table_td_contents">
                ...
                <tr>
                    ...
                    <td class="table_td_contents">
                     	<select id="isOrderLimit" name="isOrderLimit" class="select" <%=(!"ADM".equals(userInfoDto.getSvcTypeCd()) || "1".equals(detailDto.getClt_islimit())) ? "disabled style=\"background-color: #eeeeee\" " : "" %>>
                    ...
                    <td class="table_td_contents">
                        <select class="select" id="prePay" name="prePay" <%=("1".equals(detailDto.getClt_isprepay())) ? "disabled style=\"width: 125px;background-color: #eeeeee\" " : "style=\"width: 125px;\"" %>>
                    ...
                    <td class="table_td_contents">
						<input id="autOrderLimitPeriod" type="text" name="autOrderLimitPeriod" value="<%=detailDto.getAutOrderLimitPeriod()%>" style="width: 30px;"/> 일
...
%>
				...
				<tr>
					<td align="center" colspan="6">
						...
						<button id='closeButton' class="btn btn-default btn-sm" style="<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>" onclick="javaScript:window.close();" ><i class="fa fa-times"></i> 닫기</button>
					</td>
				</tr> 
			</table> <!-- 컨텐츠 끝 -->
        </td>
