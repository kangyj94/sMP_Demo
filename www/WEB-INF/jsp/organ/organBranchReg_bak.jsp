	...
	$.post(
		...
		function(arg){ 
			...
			if(branchInfo!=null) {
				...
				$("#phoneNum").val(branchInfo.phoneNum);
				...
				$("#accountTelNum").val(branchInfo.accountTelNum);            
            ...
            <td>
               ...
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                     ...
                     <td class="table_td_contents">
                        <input id="homePage" name="homePage" type="text" value="" size="20" maxlength="30" style="width: 98%" style="ime-mode: disabled;" />
                     </td>
                  </tr>
                  <tr>
                     <td colspan="6" height='1' bgcolor="eaeaea"></td>
                  ...
                  <tr>
                     ...
                     <td colspan="5" class="table_td_contents">
                        <input id="sharpMail" name="sharpMail" type="text" value="" size="20" maxlength="30" /> ex)법인사업자 : 대표#unpamsbank.법인, 개인사업자 : 대표#unpamsbank.사업</td>
                  </tr>
                  <tr>
                     <td colspan="6" height='1' bgcolor="eaeaea"></td>
                  </tr>
                  <tr>
                     ...
                     <td colspan="3" class="table_td_contents">
                        ...
                        <a href="#"> <img id="btnPost" src="/img/system/btn_icon_search.gif" width="20" height="18" class='icon_search' style="border: 0px; vertical-align: middle;" />
                        </a>
                        <input id="addres" name="addres" type="text" value="" size="20" maxlength="30" style="width: 50%"/>
                     </td>
                  ...
                  <tr>
                     ...
                     <td class="table_td_contents">
                        <input id="closeReason" name="closeReason" type="text" value="" size="20" maxlength="30" style="width: 98%" />
                     </td>
                  </tr>
                  <tr>
                     <td colspan="6" height='1' bgcolor="eaeaea"></td>
                  ...
                  <tr>
                     ...
                     <td class="table_td_contents">
                        <select class="select" id="branchGrad" name="branchGrad">
                           ...
                           <%
                           	@SuppressWarnings("unchecked")
                           	List<CodesDto> mGradeCode = (List<CodesDto>) request
                           			.getAttribute("mGradeCode");
...
%>
                  ...
                  <tr>
                     ...
                     <td class="table_td_subject" width="100">
                        신용평가서첨부 <a href="#"> <img id="btnAppSalAttach" name="btnAppSalAttach" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_type2_fileRegister.gif" style="border: 0px" />
                        </a>
                     </td>
                     <td class="table_td_contents">
...
<%}%>
                  ...
                  <tr>
                     <td class="table_td_subject" width="100">
                        통장사본첨부 <a href="#"> <img id="btnAttach1" name="btnAttach1" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_type2_fileRegister.gif" style="border: 0px" />
                        </a>
                     </td>
                     <td class="table_td_contents">
                     ...
                     <td class="table_td_subject" width="100">
                        기타첨부1 <a href="#"> <img id="btnAttach2" name="btnAttach2" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_type2_fileRegister.gif" style="border: 0px" />
                        </a>
                     </td>
                     <td class="table_td_contents">
...
%>                              
                  ...
                  <tr>
                     <td class="table_td_subject" width="100">
                       기타첨부2 <a href="#"> <img id="btnAttach3" name="btnAttach3" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_type2_fileRegister.gif" style="border: 0px" />
                        </a>
                     </td>
                     <td class="table_td_contents">
...
<!--                         <input id="payBillDay" name="payBillDay" type="text" value="30" size="20" maxlength="30" style="width: 20px" />일 -->
                     </td>
                     <td class="table_td_subject9" width="100">회계담당자명</td>
                     <td class="table_td_contents">
                        <input id="accountManageNm" name="accountManageNm" type="text" value="" size="20" maxlength="30" style="width: 98%" />
                     </td>
...
%>
                     ...
                     <td class="table_td_contents">
                        <input id="accountNum" name="accountNum" type="text" value="" size="20" maxlength="20" onkeydown="return onlyNumber(event)" />
                        (-없이)
                     </td>
                  </tr>
                                    <tr>
                  	<td class="table_td_subject9" width="100">주문제한 기간</td>
                  	<td class="table_td_contents">
                  		<input type="text" id="autOrderLimitPeriod" name="autOrderLimitPeriod" value="100"/> 일
                  	</td>
                  </tr>
                  <tr>
                     <td colspan="6" class="table_top_line"></td>
               ...
               <table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 27px;">
                  <tr>
                     ...
                     <td width="50" class="stitle">
                        <a href="#"> <img id="regButton" name="regButton" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_icon_plus.gif" width="20" height="18"
                              style="border: 0px; vertical-align: middle;" />
                        </a> <a href="#"> <img id="delButton" name="delButton" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_icon_minus.gif" width="20" height="18"
                              style="border: 0px; vertical-align: middle;" />
                        </a>
                     </td>
                  </tr>
            ...
            <td>
               ...
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                     ...
                     <td class="table_td_contents">
                        <input id="userEmail" name="userEmail" type="text" value="" size="25" maxlength="30" style="ime-mode: disabled;" />
                        ex)admin@unpamsbank.com
                     </td>
                  </tr>
                  <tr>
