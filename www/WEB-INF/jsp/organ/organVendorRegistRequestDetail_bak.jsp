...
%>				
			<!-- 확인요청 -->
			<a href="#">
				<img id="btnApp" name="btnApp" src="/img/system/btn_type5_approve2.gif" width="118" height="23" style="border: 0px;<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_CONFIRM")%>" />
			</a>
			<a href="#">
			...
			<!-- 승인요청 -->
			<a href="#">
				<img id="btnReqApp" name="btnReqApp" src="/img/system/btn_type5_1_confirm.gif" width="65" height="23" style="border: 0px;<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_APP_REQ")%>" />                   
			</a>
			<a href="#">
