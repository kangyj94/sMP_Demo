      ...
      <table width="977" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <table width="757px" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td colspan="2" align="left"><img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/map_tab_03.gif" width="430" height="27" border="0" usemap="#tab"/></td>
              </tr>
              <tr>
                <td colspan="2">&nbsp;</td>
              </tr>
              <tr>
                <td colspan="2" align="left"><img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/map_g.gif" width="713" height="410" alt="버스 노선안내 서현역 SK telesys 판교연구소 "/></td>
              </tr>
              <tr>
                <td colspan="2">&nbsp;</td>
              </tr>
...
<map name="tab"><area shape="rect" coords="101,1,201,26" href="/homepage/company/company_05_02.home" />
  <area shape="rect" coords="2,1,102,26" href="/homepage/company/company_05.home"/>
</map>
</body>
</html>