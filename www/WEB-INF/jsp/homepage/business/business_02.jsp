      ...
      <table width="977" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <table width="757px" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="300"><img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/business_st_02.gif" width="300" height="38"/></td>
                <td width="457" class="locacion"><img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/icon_home.gif" width="12" height="11"/> Home &gt; 사업소개 &gt;<span class="orange"> 서비스 원칙</span></td>
              </tr>
              <tr>
                <td colspan="2"><img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/contents_line.gif" width="757" height="19"/></td>
              </tr>
              <tr>
                <td colspan="2"><p><img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/business_img_02.gif" alt="품질보장(사전 품질관리 시스템 운영,자재관리위원회 운영,전문 품질관리자 운영,On-Line상 품질평가 자료 관리),합리적가격(합리적인 구매비용 실현,구매관련 행정업무의 간소화,품질관리 비용 및 업무 감소,예정정보 관리를 통한 공사 단축),납기준수(납기 보증 시스템 운영(납품보증일),실시간 Monitoring을 예상납기 확인,물류 전문 회사의 배송 강점 보유)" width="757" height="299" /></p></td>
              </tr>
            </table>
            <!-- 메인 컨텐츠 내용 끝-->
            </td>
