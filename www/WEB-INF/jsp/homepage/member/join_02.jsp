...
function fnAuth(){
	...
	if(frm.basicChk[0].checked == true && frm.individualChk[0].checked == true){
		...
		fnAuthBusinessNumberDialog("VEN", "REG", '0', "", "fnCallBackAuthBusinessNumber");
	}else{
...
// 			{ svcTypeCd:'ven', businessNum:$("#businessNum").val(), contract_userNm:$("#contract_userNm").val(), contract_version:'1.1' },
// 			function(arg){
...
// 		location.href = "/homepage/member/requestVendor.home";
// 	}else{
// 		alert("약관에 동의하셔야 가입등록을 진행 할 수 있습니다.");
// 	}
// }
...
function chk(check) {
	var frm = document.frm;
	frm.action = "/homepage/member/requestVendor.home";
	frm.submit();
}
					...
					<tr>
						...
						<!-- 메인 컨텐츠 내용 시작-->
							<table width="757px" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td width="300"><img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/user_st_01_03.gif" width="300" height="38" /></td>
									<td width="457" class="locacion"><img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/icon_home.gif" width="12" height="11" /> Home &gt;<span class="orange"> 공급사 회원가입</span></td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="2" align="center" >
										<a href="#">
											<img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/btn_next.gif" border="0" onclick="fnAuth()"/>
										</a>
<!-- 										<a href="/VenContractDownload.docx">  -->
