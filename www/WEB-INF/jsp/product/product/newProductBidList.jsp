...
jq(function() {
	jq("#list").jqGrid({
		...
		colModel:[
			...
			{name:'제조사',index:'제조사',width:120,align:"center",search:false,sortable:true, editable:false },
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				...
				<td height="29" class="ptitle">
					입찰조회 운영사 &nbsp;<span class="txt_notice">*운영사와 공급사는 해당 페이지를 통해 입찰 내용을 확인한다.</span></td>
