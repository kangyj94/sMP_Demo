...
<%
	...
	//상품구분 
	@SuppressWarnings("unchecked")
	List<CodesDto> codesDto =  (List<CodesDto>) request.getAttribute("ORDERGOODSTYPE");
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td colspan="5" class="table_td_contents">
					<input id="srcMajoCodeName" name="srcMajoCodeName" type="text" value="" size="20" maxlength="30" style="width:400px" readonly="readonly" onkeyDown="if(event.keyCode==8) {event.keyCode=0;return false;}" />
					<input id="srcCateId" name="srcCateId" type="hidden" value="" readonly="readonly" />
					<a href="#"><img id="btnSearchCategory" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_icon_search.gif" class="icon_search" style="width:20px;height:18px;border:0; vertical-align: middle;cursor: pointer;" /></a>
					<a href="#"><img id="btnEraseCategory" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_icon_clear.gif" class="icon_search" style="width:20px;height:18px;border:0; vertical-align: middle;cursor: pointer;" /></a></td>
			</tr>
			<tr>
				<td colspan="6" height="1" bgcolor="eaeaea"></td>
			</tr>
			<tr>
				...
				<td class="table_td_contents">
					<input id="srcGoodIdenNumb" name="srcGoodIdenNumb" type="text" value="" size="" maxlength="50" /></td>
			...
			<tr>
				...
				<td class="table_td_contents">
					<input id="srcGoodSameWord" name="srcGoodSameWord" type="text" value="" size="" maxlength="50" /></td>
				<td class="table_td_subject">상품구분</td>
				<td class="table_td_contents">
					<select id="srcGoodClasCode" name="srcGoodClasCode" style="width:80px;" class="select">
						<option value="">전체</option>
<% for(CodesDto codesDtoInfo : codesDto  ){  %>
                        <option value="<%=codesDtoInfo.getCodeVal1()%>"><%=codesDtoInfo.getCodeNm1()%></option>
<% } %>   
					</select></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3" class="table_td_contents">
					<input id="srcBorgName" name="srcBorgName" type="text" value="" size="" maxlength="50" style="width:400px;" class="blue" />
					...
					<a href="#"><img id="btnBuyBorg" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_icon_search.gif" style="width:20px;height:18px;border:0;" align="middle" class="icon_search" /></a></td>
...
<%	if("ADM".equals(userInfoDto.getSvcTypeCd())) { %>
					...
					<a href="#"><img id="btnVendor" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_icon_search.gif" style="width:20px;height:18px;border:0;" align="middle" class="icon_search"<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>" /></a></td>
<%	} else { %>
					...
					<input id="srcVendorId" name="srcVendorId" type="hidden" value="<%=userInfoDto.getBorgId()%>" /></td>
<%	} %>
			</tr>
			<tr>
				<td colspan="6" height="1" bgcolor="eaeaea"></td>
