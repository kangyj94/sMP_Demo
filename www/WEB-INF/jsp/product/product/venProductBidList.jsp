...
<%
	...
	String listHeight = "$(window).height()-267 + Number(gridHeightResizePlus)";
...
jq(function() {
	jq("#list").jqGrid({
		...
		datatype: 'json',
		mtype: 'POST',
		colNames:['입찰번호','입찰명','상품명','대표상품규격','매입단가','제조사','입찰상태','입찰시작일','등록자','투찰여부'],
		colModel:[
			{name:'입찰번호',index:'입찰번호',width:80,align:"center",search:false,sortable:true, editable:false },
			{name:'입찰명', index:'입찰명',width:130,align:"center",search:false,sortable:true, editable:false },
			{name:'상품명',index:'상품명',width:130,align:"center",search:false,sortable:true, editable:false },
			{name:'대표상품규격',index:'대표상품규격',width:130,align:"center",search:false,sortable:true, editable:false },
			{name:'매입단가',index:'매입단가',width:70,align:"center",search:false,sortable:true, editable:false },
			{name:'제조사',index:'제조사',width:130,align:"center",search:false,sortable:true, editable:false },
			{name:'입찰상태',index:'입찰상태',width:60,align:"center",search:false,sortable:true, editable:false },
			{name:'입찰시작일',index:'입찰시작일',width:60,align:"center",search:false,sortable:true, editable:false },
			{name:'등록자',index:'등록자',width:60,align:"center",search:false,sortable:true, editable:false },
			{name:'투찰여부',index:'투찰여부',width:60,align:"center",search:false,sortable:true, editable:false }
		],
		postData: {},
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				...
				<td height="29" class="ptitle">
					입찰조회 공급사 &nbsp;<span class="txt_notice">*운영사와 공급사는 해당 페이지를 통해 입찰 내용을 확인한다.</span></td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="table_td_contents">
					<input id="srcLoginId4" name="srcLoginId4" type="text" value="" size="" maxlength="50" /></td>
				<td class="table_td_subject" width="100">입찰명</td>
				<td class="table_td_contents">
					<input id="srcLoginId4" name="srcLoginId4" type="text" value="" size="" maxlength="50" /></td>
				<td colspan="-1" class="table_td_subject" width="130">입찰상태</td>
				<td class="table_td_contents">
				...
				<tr>
					...
					<td colspan="-1" class="table_td_subject">시작일
...
<tr>
	<td height="27px" align="right" valign="bottom">
		<a href="#"><span id="detButton">입찰상세</span></a>
