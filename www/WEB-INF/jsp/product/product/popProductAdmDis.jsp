...
%>
		...
		<div class="Ac mgt_10" style="height: 25px;">
...
function fnGridInit() {
    ...
    $("#list2").jqGrid({
        url:'<%=Constances.SYSTEM_CONTEXT_PATH %>/product/selectGoodVendorListForDis/list.sys',
        datatype: 'json',
        mtype: 'POST',
        <% if (repre_good.equals("Y")) { %>
...
//                 }
    ...
    $("#list3").jqGrid({
        ...
        colModel:[
            ...
            {name:'MNGT',     width:40,  align:'center', sortable:false, hidden:true},//관리
