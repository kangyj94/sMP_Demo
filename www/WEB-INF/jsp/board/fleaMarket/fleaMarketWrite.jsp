...
<%
	...
	if(boardDto!=null) {
		...
		req_Sale_Amout = boardDto.getReq_Sale_Amout();
		tran_Vehi_Proc = boardDto.getTran_Vehi_Proc();
		regi_User_Numb = boardDto.getRegi_User_Numb();
		regi_Date_Time = boardDto.getRegi_Date_Time();
		user_Phon_Numb = boardDto.getUser_Phon_Numb();
		user_Mail_Addr = boardDto.getUser_Mail_Addr();
...
$(document).ready(function(){
    ...
    $("#delButton").click( function(){ 
    	var popurl = "<%=Constances.SYSTEM_CONTEXT_PATH%>/board/fleaMarketTransGrid.sys";
    	document.frm.oper.value = "del";
...
<%	} %>
				<tr>
					...
					<td colspan="3" class="table_td_contents">
						<input type="text" id="user_Phon_Numb" name="user_Phon_Numb" class="input" style="width:68%" value="<%=user_Phon_Numb %>"/>	
					</td>
				</tr>
				<tr>
					<td colspan="4" height='1' bgcolor="eaeaea"></td>
				...
				<tr>
					...
					<td colspan="3" class="table_td_contents">
						<input type="text" id="user_Mail_Addr" name="user_Mail_Addr" class="input" style="width:68%" value="<%=user_Mail_Addr %>"/>	
					</td>
				</tr>
				<tr>
					<td colspan="4" height='1' bgcolor="eaeaea"></td>
...
<%	} %>
			<a href="#"><img id="regButton" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_type5_save.gif" style="border: 0px;" /></a>
...
<%	}	%>
	...
	$.post(
		"<%=Constances.SYSTEM_CONTEXT_PATH %>/board/fleaMarketTransGrid.sys",
		{ 	regi_User_Numb:regi_User_Numb, title:title, message:message, oper:oper, board_Type:board_Type, 
			req_Sale_Amout:req_Sale_Amout, tran_Vehi_Proc:tran_Vehi_Proc, user_Phon_Numb:user_Phon_Numb, board_No:board_No,user_Mail_Addr:user_Mail_Addr,
