...
// var _clientId = "0";
// var _branchId = "0";
function fnInitStandardCategoryComponent(_groupId, _clientId, _branchId){
	//alert('Start Method fnInitStandardCategoryComponent()!!!!'); 
	$.post(	//조회조건의 권역세팅
			'<%=Constances.SYSTEM_CONTEXT_PATH %>/category/getBuyerDisplayCategoryInfoAdmListJQ.sys',
			{schRefCateSeq:'', _groupId:_groupId, _clientId:_clientId, _branchId:_branchId},
			function(arg){
...
// 	_groupId = par_groupId;
// 	_clientId = par_clientId;
// 	_branchId = par_branchId;
