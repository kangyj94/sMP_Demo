...
// viewer Version
var rex_viewer_version = "1,0,0,212";
...
var rex_gsPreViewFeatures = "center=yes,scrollbars=no,status=no,toolbar=no,resizable=1,location=no,menu=no,width=860,height=600";
var rex_gsPreViewFeaturesModal = "center:yes;resizable:no;scroll:no;status:no;dialogWidth:860px;dialogHeight:600px";
...
//IE11 버전 업데이트 기존 rex_Agent 는 주석처리 
