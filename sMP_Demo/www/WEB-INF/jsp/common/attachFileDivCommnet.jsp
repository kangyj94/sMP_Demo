	...
	new AjaxUpload(btnUpload, {
		...
		onComplete: function(file, response){
			...
			if (result.success == false) {
				...
				eval(fnCallback+"('"+rtn_attach_seq+"','"+rtn_attach_file_name+"','"+rtn_attach_file_path+"','"+seq+"');");
			}
		}
	});
...
var fnCallback = "";
function fnUploadDialog(attach_title, attach_seq, callbackString,chkSize, seq) {
