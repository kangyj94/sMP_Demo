		...
		<table width="100%" style="height:27px;" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td align="right" class="ptitle">
					...
					<img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_type3_search.gif" style="width:85px;height:23px;" /></td>
			</tr>
		</table>
		<!-- 타이틀 끝 -->
	</td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td colspan="3" class="table_td_contents">
					<input id="srcLoginId4" name="srcLoginId4" type="text" value="" size="20" maxlength="30" style="width:400px;" /></td>
				<td class="table_td_subject" width="100">요청일자</td>
				<td class="table_td_contents">
					<input id="srcLoginId18" name="srcLoginId18" type="text" value="" size="20" maxlength="30" /></td>
			</tr>
			<tr>
				<td colspan="6" height="1" bgcolor="eaeaea"></td>
			</tr>
			<tr>
				...
				<td colspan="3" class="table_td_contents">
					<input id="srcLoginId19" name="srcLoginId19" type="text" value="" size="20" maxlength="30" style="width:400px;" /></td>
				<td class="table_td_subject">진행상태</td>
				<td class="table_td_contents">
					<input id="srcLoginId20" name="srcLoginId20" type="text" value="" size="20" maxlength="30" /></td>
			</tr>
			<tr>
				<td colspan="6" height="1" bgcolor="eaeaea"></td>
			</tr>
			<tr>
				...
				<td colspan="3" class="table_td_contents">
					<input id="srcLoginId22" name="srcLoginId22" type="text" value="" size="20" maxlength="30" style="width:400px;" /></td>
			...
			<tr>
				...
				<td colspan="5" class="table_td_contents4">
					<textarea name="textarea" id="textarea" cols="45" rows="10" style="width:740px; height:50px"></textarea></td>
			</tr>
			<tr>
				<td colspan="6" height="1" bgcolor="eaeaea"></td>
			</tr>
			<tr>
				...
				<td colspan="3" class="table_td_contents">
					<input id="srcLoginId19" name="srcLoginId19" type="text" value="" size="20" maxlength="30" style="width:400px;" /></td>
				<td class="table_td_subject">입찰번호</td>
				<td class="table_td_contents">
					<input id="srcLoginId20" name="srcLoginId20" type="text" value="" size="20" maxlength="30" /></td>
			</tr>
			<tr>
