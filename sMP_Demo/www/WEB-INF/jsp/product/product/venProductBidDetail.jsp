...
jq(function() {
	jq("#list").jqGrid({
		...
		datatype: 'json',
		mtype: 'POST',
		colNames:['*공급업체명','공급업체코드','등록일','*매입단가','대표자','연락처','대표이미지등록여부','상세설명등록여부','품목등록여부'],
		colModel:[
			{name:'*공급업체명',index:'*공급업체명',width:70,align:"center",search:false,sortable:true, editable:false },
			{name:'공급업체코드', index:'공급업체코드',width:70,align:"center",search:false,sortable:true, editable:false },
			...
			{name:'품목등록여부',index:'품목등록여부',width:70,align:"center",search:false,sortable:true, editable:false }
		],
		postData: {},
	...
	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="table_td_subject">품목등록일자</td>
				<td class="table_td_contents">
			...
			<tr>
				...
				<td colspan="5" class="table_td_contents">
					<input id="srcLoginId4" name="srcLoginId2" type="text" value="" size="20" maxlength="30" style="width:400px;" class="input_text_none" /></td>
			</tr>
			<tr>
				<td colspan="6" height="1" bgcolor="eaeaea"></td>
			</tr>
			...
			<tr>
				...
				<td class="table_td_contents">
					<input id="srcLoginId6" name="srcLoginId2" type="text" value="" size="20" maxlength="30" /></td>
				<td class="table_td_subject">납품소요일</td>
				<td class="table_td_contents">
					<input id="srcUserNm" name="srcUserNm" type="text" value="" size="10" maxlength="10" class="input_text_none" />일</td>
			</tr>
			<tr>
				<td colspan="6" height="1" bgcolor="eaeaea"></td>
			</tr>
				...
				<td colspan="5">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="table_td_subject" width="100">대표품목이미지</td>
			...
			<tr>
				<td class="table_td_subject">품목상세내역</td>
				<td colspan="5" class="table_td_contents">
