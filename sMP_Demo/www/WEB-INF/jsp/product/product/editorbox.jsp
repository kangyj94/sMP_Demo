<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
   ...
   <!--
    ...
    <!-- modify document.domain with yours if you want XSS -->
            ...
            <div id="tx_toolbar_basic2" class="tx-toolbar tx-toolbar-basic"><div class="tx-toolbar-boundary">
                ...
                <ul class="tx-bar tx-bar-left tx-group-font">
                    ...
                    <li class="tx-list">
                        ...
                        <div id="tx_forecolor_menu2" class="tx-menu tx-forecolor-menu tx-colorpallete" unselectable="on"></div>
                    </li>
                    <li class="tx-list">
            ...
            <div id="tx_toolbar_advanced2" class="tx-toolbar tx-toolbar-advanced"><div class="tx-toolbar-boundary">
                ...
                <ul class="tx-bar tx-bar-left">
                    <li class="tx-list">
                        ...
                        <div id="tx_tabletemplate_menu2" class="tx-tabletemplate-menu tx-menu tx-colorpallete" unselectable="on"></div>
                    </li>
                </ul>
    ...
    <div id="tx_canvas2" class="tx-canvas">
        <div id="tx_loading2" class="tx-loading"><div><img src="/daumeditor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
    ...
    <div id="tx_resizer2" class="tx-resize-bar">
        ...
        <img id="tx_resize_holder2" src="/daumeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
    </div>
    ...
    <div id="tx_attach_div2" class="tx-attach-div">
        ...
        <div id="tx_attach_box2" class="tx-attach-box">
            <div class="tx-attach-box-inner">
                <div id="tx_attach_preview2" class="tx-attach-preview"><p></p><img src="/daumeditor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
...
<script type="text/javascript">
    var config2 = {
        ...
        size: {
            contentHeight: 250 /* 지정된 본문영역의 넓이가 있을 경우에 설정 */
        }
        
    };

    EditorJSLoader.ready(function(Editor) {
        var editor = new Editor(config2);
    });
</script>
...
<textarea id="sample_contents_source2" style="display:none;">
...
<script type="text/javascript">
    function loadContent2() {
        ...
        Editor.modify({
            ...
            "content": document.getElementById("tx_load_content") /* 내용 문자열, 주어진 필드(textarea) 엘리먼트 */
        });
    }
</script>
