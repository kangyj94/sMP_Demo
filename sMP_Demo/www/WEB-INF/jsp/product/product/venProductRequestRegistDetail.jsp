	...
	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				...
				<td height="29" class="ptitle">고객사상품등록요청 상세</td>
			</tr>
		</table>
		<!-- 타이틀 끝 -->
	</td>
	...
	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="table_td_subject">고객사상품등록요청상태</td>
			...
			<tr>
				<td class="table_td_subject" width="100">고객사상품등록일</td>
				<td class="table_td_contents">
...
<tr>
	<td align="center">
		<img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_type5_newOrder.gif" style="width:110px;height:23px;" /></td>
</tr>
</table>
