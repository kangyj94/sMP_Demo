...
jq(function() {
	jq("#list").jqGrid({
		...
		datatype: 'json',
		mtype: 'POST',
		colNames:['카테고리명','상품명','공급사','진행상태','상품규격','요청일자','매입단가','계약시작일','계약종료일','등록자'],
		colModel:[
			{name:'카테고리명',index:'카테고리명',width:70,align:"center",search:false,sortable:true, editable:false },
			{name:'상품명', index:'상품명',width:70,align:"center",search:false,sortable:true, editable:false },
			{name:'공급사',index:'공급사',width:70,align:"center",search:false,sortable:true, editable:false },
			{name:'진행상태',index:'진행상태',width:70,align:"center",search:false,sortable:true, editable:false },
			{name:'상품규격',index:'상품규격',width:70,align:"center",search:false,sortable:true, editable:false },
			...
			{name:'계약시작일',index:'계약시작일',width:70,align:"center",search:false,sortable:true, editable:false },
			{name:'계약종료일',index:'계약종료일',width:70,align:"center",search:false,sortable:true, editable:false },
			{name:'등록자',index:'등록자',width:70,align:"center",search:false,sortable:true, editable:false }
		],
		postData: {},
...
<script type="text/javascript">
function detail(){
	var popurl = "/product/productRequestRegistDetail.sys";
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				...
				<td height="29" class="ptitle">
					공급사상품등록요청조회
					&nbsp;<span class="txt_notice">*운영사 로그인시 공급사 택가능 / 공급사 접근시 급사 수정불가</span></td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td colspan="3" class="table_td_contents">
					<input id="srcLoginId" name="srcLoginId" type="text" value="" size="" maxlength="50" style="width:400px" />
					<img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_icon_search.gif" style="width:20px;height:18px;" align="middle" /></td>
				<td class="table_td_subject">상품명</td>
				<td class="table_td_contents">
					<input id="srcLoginId2" name="srcLoginId2" type="text" value="" size="" maxlength="50" /></td>
			</tr>
			<tr>
				<td colspan="6" height="1" bgcolor="eaeaea"></td>
			</tr>
...
<tr>
	<td height="27px" align="right" valign="bottom">
		<a href="#"><span id="detButton">공급사상품등록요청상세</span></a>
