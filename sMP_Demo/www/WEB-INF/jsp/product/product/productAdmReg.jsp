                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="table_td_contents">
                                    ...
                                    <button id='btnSearchCategory' class="btn btn-default btn-xs" style="<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>"><i class="fa fa-search"></i> 조회</button>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" class="table_top_line"></td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 27px">
                            <tr>
                                ...
                                <td align="right" class="stitle">
                                    <!-- btnAdd -->
                                    <button id='btnCategoryExcel' class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"></i> 상품진열카테고리 출력</button>
                                </td>
                            </tr>
                        </table>
                    </td>
...
<!--                                     <input id="btnProdVendorDel" type="button" value="공급사삭제" style="cursor: pointer;" /> -->
                                    ...
                                    <!-- 공급사정보복사 -->
                                    <button id='btnProdVendorCopy' class="btn btn-info btn-xs" style="<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>"><i class="fa fa-floppy-o"></i>공급사정보 복사</button>
                                    <!-- 공급사정보추가  -->
                                    <button id='btnProdVendorAdd' class="btn btn-info btn-xs" style="<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>"><i class="fa fa-floppy-o"></i>공급사정보 추가</button>
                                    <!-- 공급사삭제 종료요청으로 데처 -->
                                    <button id='btnProdVendorDel' class="btn btn-warning btn-xs" style="<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>"><i class="fa fa-trash-o"></i>공급사정보 삭제</button>
                                    <button id='btnVendorExcel' class="btn btn-success btn-xs"><i class="fa fa-file-excel-o"></i> 상품공급업체정보 출력</button>
                                </td>
                            </tr>
                        </table>
                        <!-- 타이틀 끝 -->
                                    ...
                                    <table width="98%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center" class="stitle" style="text-align: center;">
                                                <!-- 공급사정보추가  -->
                                                <button id='btnProdMstSave' class="btn btn-primary btn-xs" style="<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>"><i class="fa fa-floppy-o"></i> 마스터 정보 저장</button>
                    ...
                    <td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 27px;">
                            <tr>
                                ...
                                <td align="right" class="stitle">
                                    <button id='btnDispAdd' class="btn btn-primary btn-xs" style="<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>"><i class="fa fa-floppy-o"></i> 등록</button>
...
<%--                                     <img id='btnDispTrash' src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/icon/Trash.gif" width="15" height="15" style="cursor: pointer;<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>" /> --%>
                                    <!-- btnAdd -->
                                    <button id='btnDispExcel' class="btn btn-success btn-xs" ><i class="fa fa-file-excel-o"></i> 현 판가정보 출력</button>
                                </td>
                            </tr>
                        </table>
                        <!-- 타이틀 끝 -->
