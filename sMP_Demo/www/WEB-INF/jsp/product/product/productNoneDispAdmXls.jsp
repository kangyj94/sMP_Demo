...
$(function(){
    ...
    new AjaxUpload(btnUpload, {
        action: '<%=Constances.SYSTEM_CONTEXT_PATH%>/productManage/productNoneDispExcelUpload.sys',
        name: 'excelFile',
        data: {},
...
<script type="text/javascript">
	...
	var fnInitGrid = function () {
	    jq("#list").jqGrid({
	        datatype: "local",
	        colNames:[  '*상품코드' ,'*상품명' ,'*공급사코드' ,'에러'],
	        colModel:[{name:'good_iden_numb', index:'good_iden_numb', width:100 ,sortable:false, align:'center' },
	        ...
	        jsonReader: { root:"list", cell:"cell" }
	    });	    
	};

// 엑셀 다운로드 
function exportExcel() {
	var colLabels = ['*상품코드','*상품명','*공급사코드','에러'];	//출력컬럼명
	var colIds = ['good_iden_numb','good_name','vendorCd','rtnError'];	//출력컬럼ID
	var numColIds = [];	//숫자표현ID
	var sheetTitle = "상품권역 일괄종료 처리결과";	//sheet 타이틀
	var excelFileName = "uploadGoodNoneDispList";	//file명
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                        ...
                        <td height="29" class='ptitle'>상품권역(진열) 일괄종료</td>
                    </tr>
                </table>
                <!-- 타이틀 끝 -->
            </td>
        ...
        <tr>
            <td align="right" valign="bottom">
            	<img id="prodAllButton" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_type3_goodsAllReg2.gif" style='cursor: pointer; border:0;<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>' />
            	<img id="dispAllButton" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/system/btn_type3_goodsAllReg.gif" style='cursor: pointer; border:0;<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>' />
                    ...
                    <div id="dialogHandle">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-image: url('<%=Constances.SYSTEM_IMAGE_URL%>/img/system/popup_titlebar_mid.gif');">
                            <tr>
                                ...
                                <td class="popup_title">상품권역 종료 일괄업로드</td>
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr valign="top">
                                        <td height="23px" class="table_td_contents">2. 공급사코드를 입력하지 않으시면 상품코드 모두 해당 됩니다..</td>
                                    </tr>
                                    <tr valign="top">
                                        <td height="23px" class="table_td_contents">
                                            <a href="<%=Constances.SYSTEM_IMAGE_URL%>/upload/sample/productNoneDispExcellUploadSample.xlsx">샘플파일 다운로드</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
