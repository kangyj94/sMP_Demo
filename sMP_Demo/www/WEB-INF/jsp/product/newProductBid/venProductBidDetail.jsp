...
jq(function() {
	jq("#list").jqGrid({
		...
		colModel:[
			...
			{name:'상품등록여부',index:'상품등록여부',width:70,align:"center",search:false,sortable:true, editable:false }
		],
		postData: {},
	...
	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="table_td_subject">상품등록일자</td>
				<td class="table_td_contents">
			...
			<tr>
				<td class="table_td_subject">상품상세내역</td>
				<td colspan="5" class="table_td_contents">
