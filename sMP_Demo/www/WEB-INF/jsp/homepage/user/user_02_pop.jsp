...
<%-- 								<td width="457" class="locacion"><img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/icon_home.gif" width="12" height="11"/> Home &gt; 이용안내 &gt;<span class="orange"/> 운영 담당자 안내</span></td> --%>
							</tr>
							<tr>
								<td colspan="2">
							...
							<tr>
								<td colspan="2">
									<img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/mem_ins_box.gif" alt="Okplaza 회원 등록은 서류 평가 등의 절차에 따라 이루어 집니다. 자세한 절차은 상품별 운영 담당자에게 문의해 주시길 바랍니다." width="757" height="48" />
								</td>
							</tr>
							<tr>
								<td colspan="2">&nbsp;</td>
								...
								<td colspan="2">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td class="bbs_td_subject2" width="180" colspan="3">업무 구분</td>
											<td class="table_td_split2"></td>
										...
										<tr>
											<td class="table_td_split2"rowspan="8"></td>
											<td class="bbs_td_contents2" style="text-align: center" rowspan="7">
												<font color="#663333">자재 문의</font>
											</td>
											<td class="table_td_split2"></td>
...
<!-- 												<font color="#663333">OJC, 전송망자재</font></td> -->
<!-- 											<td class="table_td_split2"></td> -->
<!-- 											<td class="bbs_td_contents2" style="line-height: 16px;">대리 이재찬</td> -->
<!-- 											<td class="table_td_split2"></td> -->
<!-- 											<td class="bbs_td_contents2">031-786-5760</td> -->
<!-- 											<td class="table_td_split2"></td> -->
<!-- 											<td class="bbs_td_contents2" style="text-align: left"> -->
<!-- 												<a href="mailto:sky2537@sk.com"><u>sky2537@sk.com</u></a> -->
<!-- 											</td> -->
<!-- 											<td class="table_td_split2"></td> -->
<!-- 										</tr> -->
<!-- 										<tr> -->
...
<!-- 										</tr> -->
										<tr>
											...
											<td class="bbs_td_contents2" style="text-align: left">
												<font color="#663333">
													개통자재: Drop/UTP/동축케이블, FTTH/HFC부대자재 등<BR>
													관로자재: 철개, 맨홀, FC관, SC내관, 망사섬유내관, COD관 등
												</font>
											</td>
											<td class="table_td_split2"></td>
										...
										<tr>
										 ...
										 <tr>
											<td class="table_td_split2" rowspan="3"></td>
											<td class="bbs_td_contents2" style="text-align: center"  rowspan="3">
