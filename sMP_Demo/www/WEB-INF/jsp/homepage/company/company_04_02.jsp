      ...
      <table width="977" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <table width="757px" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td colspan="2" align="left"><p><img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/company_04_tab_02.gif" width="428" height="27" border="0" usemap="#tab" />
                    <map name="tab" id="tab">
                      <area shape="rect" coords="202,1,302,26" href="/homepage/company/company_04_03.home" />
                      <area shape="rect" coords="1,1,101,26" href="/homepage/company/company_04.home" />
                    </map>
                </p></td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="2" align="left"><img src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/company_04_img_02.gif" width="713" height="630" /></td>
              </tr>
            </table>
            <!-- 메인 컨텐츠 내용 끝-->
            </td>
