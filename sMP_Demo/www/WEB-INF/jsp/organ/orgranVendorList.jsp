...
jq(function() {
	jq("#list").jqGrid({
		...
		datatype: 'json',
		mtype: 'POST',
		colNames:['업체코드', '공급사명', '사업자등록번호', '권역', '상태', '대표전화번호', '회계담당', '자재담당', '대표자명', '우편번호', '주소', '등록일'],
		colModel:[
			{name:'업체코드',index:'업체코드', width:90,align:"center",search:false,sortable:true, editable:false },
			{name:'공급사명',index:'공급사명', width:150,align:"center",search:false,sortable:true, editable:false },
			{name:'사업자등록번호',index:'사업자등록번호', width:150,align:"center",search:false,sortable:true, editable:false },
			...
			{name:'회계담당',index:'회계담당', width:90,align:"center",search:false,sortable:true, editable:false },
			{name:'자재담당',index:'자재담당', width:90,align:"center",search:false,sortable:true, editable:false },
			...
			{name:'주소',index:'주소', width:200,align:"center",search:false,sortable:true, editable:false },
			{name:'등록일',index:'등록일', width:90,align:"center",search:false,sortable:true, editable:false }
		],
		postData: {},
...
//개발시 삭제
function onDetail(){
	var popurl = "/organ/orgranVendorDetail.sys";
	var popproperty = "dialogWidth:900px;dialogHeight=770px;scroll=yes;status=no;resizable=no;";
// 	window.showModalDialog(popurl,null,popproperty);
	window.open(popurl, 'okplazaPop', 'width=900, height=770, scrollbars=yes, status=no, resizable=no');
}
				...
				<td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr valign="top">
							...
							<td height="29" class='ptitle'>공급사조회</td>
				...
				<td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td colspan="3" class="table_td_contents"><input id="srcLoginId" name="srcLoginId" type="text" value="" size="" maxlength="50" style="width: 80%" /> <img src="/img/system/btn_icon_search.gif" width="20" height="18" align="absmiddle" /></td>
							<td width="100" class="table_td_subject">공급사명</td>
							<td class="table_td_contents"><input id="srcLoginId2" name="srcLoginId2" type="text" value="" size="" maxlength="50" style="width: 98%" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="table_td_contents"><input id="srcLoginId4" name="srcLoginId4" type="text" value="" size="" maxlength="50" style="width: 98%" /></td>
							<td width="100" class="table_td_subject">권역</td>
							<td class="table_td_contents"><select id="srcIsDefault" name="srcIsDefault" class="select"> <option>선택하세요</option> </select></td>
							<td width="100" class="table_td_subject">상태</td>
							<td class="table_td_contents"><select id="srcIsDefault3" name="srcIsDefault3" class="select"> <option>선택하세요</option> </select></td>
						</tr>
						<tr>
							<td colspan="6" class="table_top_line"></td>
						</tr>
