...
jq(function() {
	jq("#list").jqGrid({
		...
		datatype: 'json',
		mtype: 'POST',
		colNames:['요청공급사명', '사업자등록번호', '소재지', '상태', '대표전화번호', '대표자명', '우편번호', '주소', '요청일', '승인일(등록일)'],
		colModel:[
			...
			{name:'소재지',index:'소재지', width:90,align:"center",search:false,sortable:true, editable:false },
...
//개발시 삭제
function onDetail(){
	var popurl = "/organ/organVendorRegistApprovalDetail.sys";
...
// 	window.showModalDialog(popurl,null,popproperty);
	window.open(popurl, 'okplazaPop', 'width=900, height=900, scrollbars=yes, status=no, resizable=no');
}
