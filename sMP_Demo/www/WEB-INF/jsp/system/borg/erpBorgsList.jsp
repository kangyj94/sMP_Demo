...
function initList() {
	jq("#list").jqGrid({
		...
		datatype: 'json',
		mtype: 'POST',
		colNames:['<input id=\"chkAllOutputField\" type=\"checkbox\" style=\"border:0px;\" onclick=\"allCheckBox(event)\" />','조직코드','조직유형','조직명','사업자등록번호','내용','전송일자','ERP 등록여부','처리일자','처리자명'],
		colModel:[
...
function exportExcel() {
	var colLabels = ['조직코드','조직유형','조직명','사업자등록번호','내용','전송일자','ERP 등록여부','처리일자','처리자명'];	//출력컬럼명
	...
	var sheetTitle = "ERP 등록처리";	//sheet 타이틀
			...
			<td>
				...
				<table width="1500px" border="0" cellspacing="0" cellpadding="0">
					<tr valign="top">
						...
						<td height="29" class='ptitle'>ERP 등록 처리</td>
						<td align="right">
							<button id='btnSapTrans' class="btn btn-warning btn-sm" style="<%=CommonUtils.getDisplayRoleButton(roleList, "COMM_SAVE")%>"><i class="fa fa-floppy-o"></i> ERP 등록</button>							
		...
		<tr>
			<td>
				...
				<table width="1500px" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="table_td_subject" width="100">ERP 등록여부</td>
						<td class="table_td_contents">
