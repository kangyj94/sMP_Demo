...
<%-- 구매사 계약서 리스트 --%>
function fnContractNoSignList() {
	$("#list").jqGrid({
		url:'/system/contractNoSignListJQGrid.sys',
		datatype: 'json',
		mtype: 'POST',
		colNames:['업체명','담당자','담당자 연락처'],
		colModel:[
			{name:'BORGNM',index:'BORGNM', width:150, align:"left",search:false,sortable:true},	//업체명
			{name:'USERNM',index:'USERNM', width:120, align:"center",search:false,sortable:true},	//서명일시
			{name:'MOBILE',index:'MOBILE', width:120, align:"center",search:false,sortable:true}	//서명자
		],
		postData: {
			svcTypeCd:'<%=svcTypeCd%>',
