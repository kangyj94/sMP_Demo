...
// 	$('#proposalDetailPop').jqm();  //Dialog 초기화
	$('#proposalDetailPop').jqm().jqDrag('#proposalDetailDialogHandle'); 
...
// 				}
 ...
 //전화번호 형식으로 변경
	$("#regiUserPhone").val( fnSetTelformat( $("#regiUserPhone").val() ) );
	$("#suitableMobile").html( fnSetTelformat( $("#suitableMobile").html() ) );
...
<input type="hidden" id="receiptNumStat" name="receiptNumSta"/>
	<table width="750" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td>
				<div id="proposalDetailDialogHandle">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-image: url('<%=Constances.SYSTEM_IMAGE_URL%>/img/system/popup_titlebar_mid.gif');">
						<tr>
							...
							<td style="background-color: #ea002c; height: 47px;color: #fff;font-size: 17px;font-weight: 700;">자재제안정보</td>
					...
					<tr>
						...
						<td valign="top" bgcolor="#FFFFFF" style="padding-top: 5px;">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="FINAL_RESULT_PRINT" >
								<tr>
									<td align="right" >
									<button id="propPrintBtn" type="button" class="btn btn-primary btn-xs"><i class="fa fa-print"></i>출력</button>
									</td>
								</tr>
								<tr>
									<td style="height: 5px" class="FINAL_RESULT_PRINT" ></td>
								</tr>
							</table>
							<table class="InputTable" width="100%">
								<tr>
									...
									<td colspan="5">
                                        ...
                                        <table width="100%" border="1" cellpadding="0" cellspacing="0" style="line-height:0.75em; border-collapse:collapse; border-color:#eaeaea; border-style:solid;">
	                                        ...
	                                        <tr style="border:1px ; border-color:#eaeaea; border-bottom-style: solid; line-height: 0.5em;">
								...
								<tr>
									<th width="90">제안명</th>
									<td colspan="5"><input type="text" id="titleName" name="titleName" value="" style="width: 225px" maxlength="100"/></td>
								</tr>
								<tr>
									<th width="90">제안자</th>
									<td><input type="text" id="regiUserName" name="regiUserName" value="" style="width: 100px" maxlength="15"/></td>
									<th width="90">제안일</th>
									<td><input type="text" id="regiDateTime" name="regiDateTime" value="" style="width: 100px"/></td>
									<th width="90">연락처</th>
									<td><input type="text" id="regiUserPhone" name="regiUserPhone" value="" style="width: 100px" maxlength="50" onkeydown="return onlyNumberThis(event)"/></td>
								</tr>
								<tr>
									<th width="90">e-mail</th>
									<td ><input type="text" id="regiUserEmail" name="regiUserEmail" value="" style="width: 130px" maxlength="100" style="ime-mode:disabled;"/></td>
									<th width="90">주요내용</td>  
									<td colspan="3"><input type="text" id="propPointDesc" name="propPointDesc" value="" style="width: 355px" maxlength="3000"/></td>
								</tr>
								<tr>
									<th width="90">작성가이드</th>
									<td  colspan="5" align="left">
										<table style="width: 430px; line-height:0.5em;border-collapse:inherit;">
											<tr>
								...
								<tr>
									<th width="90">첨부파일<br/>(제안자)<br/><font color="red" size="1">제한용량:각5MB씩</font></th>
									<td colspan="5" style="margin: 0px">
										<table width="100%" border="0" cellspacing="0" cellpadding="0" style="line-height: 0.75em;">
											<tr>
												<td bgcolor="#dbeaf7" align="center" style="width: 100px"><b>PPT 파일</b></td>
												...
												<td>
					                                ...
					                                <button id="btnAttach1" type="btnAttach1" class="btn btn-darkgray btn-xs">등록</button>
													</div>
												</td>
											</tr>
											<tr>
												<td bgcolor="#dbeaf7" align="center" style="width: 100px"><b>첨부 파일1</b></td>
												<%-- <td bgcolor="#dbeaf7" align="left" style="width: 67px" class="FileTdInDiv1">
					                                <a href="#">
												...
												<td>
					                                ...
					                                <div style="float:right">
					                                <button id="btnAttach2" type="btnAttach2" class="btn btn-darkgray btn-xs">등록</button>
													</div>
												</td>
											</tr>
											<tr>
												<td bgcolor="#dbeaf7" align="center" style="width: 100px"><b>첨부 파일2</b></td>
												<%-- <td bgcolor="#dbeaf7" align="left" style="width: 67px" class="FileTdInDiv1">
					                                <a href="#">
												...
												<td>
					                                ...
					                                <div style="float:right">
					                                <button id="btnAttach3" type="btnAttach3" class="btn btn-darkgray btn-xs">등록</button>
													</div>
												</td>
											</tr>
										</table>
								...
								<tr class="SKTS_RESULT">
									<th width="90">검토자</th>
									<td id="suggestTargetName">
<!-- 										<input type="text" id="suggestTargetName" name="suggestTargetName" value=""/> -->
									</td>
									<th width="90" >검토자 연락처</th>
									<td id="suitableMobile">
<!-- 										<input type="text" id="suitableMobile" name="suitableMobile" value=""/> -->
								...
								<tr class="SKTS_RESULT">
									...
									<th width="90">SKTS검토의견</th>
									<td  colspan="3"><input type="text" id="suitableContent" name="suitableContent" value="" style="width: 355px" maxlength="3000"/></td>
								</tr>
								<tr class="SKTS_RESULT">
									<th width="90">자재유형</th>
									<td ><input type="text" id="materialType" name="materialType" value="" style="width: 100px" maxlength="50"/></td>
									<th width="90" >첨부파일(SKTS)</th>
									<td colspan="3" style="margin: 0px">
										<table width="100%" style="border-collapse: inherit; border: 0;">
											<tr>
												<td bgcolor="#dbeaf7" align="center" style="width: 1px;border:0px;" class="FileTdInDiv2">&nbsp;<br/>&nbsp;</td>
												<td bgcolor="#dbeaf7" align="left" style="width: 67px;border: 0px;" class="FileTdInDiv2">
													<a href="#;">
								...
								<tr class="FINAL_RESULT">
									...
									<th width="90">최종평가의견</th>
									<td colspan="3"><input type="text" id="appraisalContent" name="appraisalContent" value="" style="width: 355px" maxlength="3000"/></td>
								</tr>
							</table> 
							<table width="100%" border="0" cellspacing="0" cellpadding="0"style="line-height: 0.5em;">
								<tr>
									<td>&nbsp;</td>
								</tr>
								<tr>
									<td align="center">
									<button id="regiJqmButton" type="button" class="btn btn-darkgray btn-sm"><i class="fa fa-plus"></i> 등록</button>
									<button id="modiJqmButton" type="button" class="btn btn-darkgray btn-sm"><i class="fa fa-save"></i> 수정</button>
									<button id="reviewJqmButton" type="button" class="btn btn-darkgray btn-sm"><i class="fa fa-save"></i> 저장</button>
									<button id="finalJqmButton" type="button" class="btn btn-darkgray btn-sm"><i class="fa fa-save"></i> 저장</button>
									<button id="delJqmButton" type="button" class="btn btn-darkgray btn-sm"><i class="fa fa-trash-o"></i> 삭제</button>
									<button id="receJqmButton" type="button" class="btn btn-darkgray btn-sm"><i class="fa fa-file-o"></i> 접수</button>
