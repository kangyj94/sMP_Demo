...
$(function() {
	$("#list").jqGrid({
		...
		colModel:[
			{name:'board_No',       index:'board_No',       key:true,  hidden:true},	//번호 시퀀스
			...
			{name:'file_list_cnt',  index:'file_List_cnt',  width:70,  align:"right",  search:false, sortable:false, editable:false},	//첨부파일갯수
			...
			{name:'hit_No',         index:'hit_No',         width:60,  align:"right",  search:false, sortable:true,  editable:false}	//조회수
		],
		postData: {srcBoardBorgType:"BUY"},
		rowNum:15, rownumbers: false, rowList:[15,30,50,100], pager: 'pager',
		height: 406,autowidth: true,
