...
<%
	...
	String              srcStartDate = CommonUtils.getCustomDay("MONTH", -1); // 날짜 세팅
...
function fnGridInit() {
	$("#list").jqGrid({
        ...
        colModel:[
            ...
            {name:'VIEW_NM',           width:210},//화면명
            {name:'TYPE_NM',           width:60,   align:'center'},//접수구분
            {name:'STATE_NM',          width:60,   align:'center'},//처리상태
            {name:'REQ_BORG_NAME',     hidden:true},//요청조직
            
            {name:'REQ_USER_NAME',     width:190,  align:'center'},//요청자
            {name:'CONFIRM_USER_NAME', width:190,  align:'center'},//접수자
            {name:'HANDLE_USER_NAME',  width:190,  align:'center'},//처리자
...
function fnRepairEdit(){
	...
	confirmMessage("수정 내용을 저장하시겠습니까?", fnRepairEditCallback); // confirm 호출
}
