...
<%
	...
	// 날짜 세팅
	String srcOrdeStartDate = CommonUtils.getCustomDay("MONTH", -2);
...
jq(function() {
	jq("#list").jqGrid({
		url:'<%=Constances.SYSTEM_CONTEXT_PATH%>/order/purchase/purchaseListJQGrid.sys', 
		datatype: 'json',
		mtype: 'POST',
		colNames:["<input id='chkAllOutputField' type='checkbox' style='border:0px;' onclick='checkBox(event)' />", '주문일자', '납품요청일', '발주의뢰일','주문유형', '주문번호', '발주차수', '상품명',  '상품규격','good_st_spec_desc' ,'발주수량', '배송처주소', '고객사', '주문자명', '인수자명', '첨부1','첨부2','첨부3', '공급사명', 'orde_type_clas_code', 'disp_good_id', 'good_iden_numb','vendorid', 'path1', 'path2', 'path3'],
		colModel:[
			...
			{name:'good_spec_desc',index:'good_spec_desc', width:150,align:"left",search:false,sortable:true, editable:false },
			{name:'good_st_spec_desc',index:'good_st_spec_desc', hidden:true, search:false,sortable:true, editable:false },
			{name:'purc_requ_quan',index:'purc_requ_quan', width:90,align:"right",search:false,sortable:true, editable:false ,sorttype:'integer',formatter:'integer',
				formatoptions:{ decimalSeparator:"", thousandsSeparator:",", decimalPlaces: 0, prefix:"" }},
			...
			{name:'orde_user_name',index:'orde_user_name', width:60,align:"left",search:false,sortable:true, editable:false },
			{name:'tran_user_name',index:'tran_user_name', width:60,align:"rigth",search:false,sortable:true, editable:false },
				...
				<td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr valign="top">
							...
							<td height="29" class='ptitle'>PICKING 등록(발주접수)</td>
