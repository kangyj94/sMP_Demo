...
function fnPasswordFind() {
	...
	$.post(
			...
			{ srcUserNm:srcUserNm, srcLoginid:srcLoginid, srcMobileNum:srcMobileNum,srcType:"pwd"},
			function(arg){
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td valign="top" bgcolor="#FFFFFF">
							<!-- 타이틀 시작 -->
							<table id="passwordDiv1" width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="15" height="27" valign="top" >
										<img id="mobileDiv2" src="<%=Constances.SYSTEM_IMAGE_URL%>/img/homepage/bullet_stitle_red.gif" width="5" height="5" class="bullet_stitle" />
									</td>
									<td class="txt_notice_red">입력정보가 정확해야 휴대전화로 비밀번호가 전송됩니다.<br/>비밀번호는 초기화 되어 발송됩니다.</td>
								</tr>
							</table>
							<!-- 타이틀 끝 -->
							<!-- 컨텐츠 시작 -->
							<table id="passwordDiv1" width="100%"  border="0" cellspacing="0" cellpadding="0">
								<tr>
								...
								<tr>
									<td class="table_td_subject_red">아이디</td>
									<td class="table_td_contents">
										<input id="srcLoginid" name="srcLoginid" type="text" value="" maxlength="15" style="width:143px" class="blue"/>
									</td>
								</tr>
								<tr>
									<td colspan="2" height='1' bgcolor="eaeaea"></td>
